          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 py-20 md:py-28 flex flex-col gap-12 md:gap-16">
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8">
              {[
                ...
                <div key={card.title} className="border border-black/[0.08] p-8 md:p-10 flex flex-col gap-5">
        ...
        <section className="w-full border-b border-black/[0.03]">
          <div className="max-w-7xl mx-auto px-6 md:px-10 py-20 md:py-28 flex flex-col gap-12 md:gap-16">
            ...
            <div className="grid md:grid-cols-3 gap-10 md:gap-16">
              <div className="flex flex-col gap-4 border-t border-black/[0.08] pt-8">
                <span className="text-5xl md:text-6xl font-body text-gray-200 italic font-bold leading-none">01</span>
                <h3 className="text-xl md:text-2xl font-instrumental italic tracking-tighter">Rigor Técnico</h3>
                <p className="text-gray-500 text-sm leading-[1.8] font-body">
                  Cada superficie se analiza antes de intervenir. No aplicamos soluciones estándar; diseñamos la ejecución exacta para cada soporte y condición de uso.
                </p>
              </div>
              <div className="flex flex-col gap-4 border-t border-black/[0.08] pt-8">
                <span className="text-5xl md:text-6xl font-body text-gray-200 italic font-bold leading-none">02</span>
                <h3 className="text-xl md:text-2xl font-instrumental italic tracking-tighter">Estética Atemporal</h3>
                <p className="text-gray-500 text-sm leading-[1.8] font-body">
                  Seleccionamos materiales y tonos que no seguirán modas pasajeras. El resultado debe verse igual de elegante dentro de diez años que el día de la entrega.
                </p>
              </div>
              <div className="flex flex-col gap-4 border-t border-black/[0.08] pt-8">
                <span className="text-5xl md:text-6xl font-body text-gray-200 italic font-bold leading-none">03</span>
                <h3 className="text-xl md:text-2xl font-instrumental italic tracking-tighter">Compromiso Local</h3>
                <p className="text-gray-500 text-sm leading-[1.8] font-body">
                  Operamos en Barcelona y sus alrededores. Conocemos las condiciones climáticas, los soportes más comunes y los proveedores de mayor confianza en la zona.
                </p>
              </div>
            </div>
          </div>
