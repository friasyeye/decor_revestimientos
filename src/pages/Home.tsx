...
import { useReveal, useRevealElement } from '../hooks/useReveal';
...
const Home = () => {
  ...
  // Fix hero height to initial viewport height to prevent stretch on mobile scroll
  useEffect(() => {
  ...
  // Image reveal for proyectos section
  const proyectosImgRef = useRevealElement();
  // Stagger for cards
  const cardsRef = useReveal('.stagger-item', { threshold: 0.1 });
          ...
          <div className="flex flex-col md:flex-row min-h-[560px] md:min-h-[680px]">
            ...
            <div className="order-2 md:order-1 md:w-1/2 flex items-center py-14 md:py-0">
              <div className="w-full px-6 md:pl-[max(2.5rem,calc((100vw-80rem)/2+2.5rem))] md:pr-10 xl:pr-16 flex flex-col gap-6 md:gap-8">
                ...
                <Link
                  to="/proyectos"
                  className="btn-press inline-flex items-center justify-center gap-2 rounded-full px-8 py-3 border border-black hover:bg-black hover:text-white self-start"
                >
            ...
            {/* IMAGE — right column, reveal on scroll */}
            <div className="order-1 md:order-2 w-full md:w-1/2 h-[300px] md:h-auto mt-16 md:mt-0 md:py-16 overflow-hidden">
              <div
                ref={proyectosImgRef as React.RefObject<HTMLDivElement>}
                className="img-reveal w-full h-full"
              >
                <picture>
      ...
      <FadeIn delay={0.1}>
        <section id="precision" className="w-full border-b border-black/[0.03]" style={{ backgroundColor: '#575353ff' }}>
          <div className="max-w-7xl mx-auto px-6 md:px-10 pt-20 pb-32 flex flex-col gap-12 md:gap-16">
              ...
              <div className="hidden md:flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  <button
                    ...
                    disabled={!canPrev}
                    aria-label="Anterior"
                    className="btn-press w-11 h-11 rounded-full border border-white/30 flex items-center justify-center text-white hover:bg-white hover:text-black disabled:opacity-25 disabled:cursor-not-allowed"
                  >
                    <ChevronLeft size={20} />
                  </button>
                  <button
            ...
            {/* SERVICIOS SLIDER — stagger on cards */}
            <div
              ref={sliderRef}
      ...
      <FadeIn delay={0.1}>
        <section id="nosotros" className="w-full border-b border-black/[0.03]">
          ...
          >
            ...
            <div className="stagger-item order-2 md:order-2 w-full md:flex md:justify-end" style={{ transitionDelay: '120ms' }}>
        ...
        <section id="whatsapp" className="max-w-7xl mx-auto px-6 md:px-4 py-24 md:py-40 text-center flex flex-col items-center">
          <div className="flex flex-col gap-8 md:gap-10 max-w-3xl">
            ...
            <div className="mt-4">
              <a
                href="https://wa.me/34603143050?text=Hola,%20vengo%20de%20la%20web%20y%20quiero%20pedir%20un%20presupuesto%20personalizado"
                className="btn-press inline-flex items-center justify-center rounded-full px-5 py-2 md:px-8 md:py-3 text-sm md:text-base border border-black bg-black text-white hover:bg-white hover:text-black"
              >
